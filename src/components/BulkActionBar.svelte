<script lang="ts">
    ...
    async function handleEnableSelected() {
        ...
        if (failCount > 0) {
            addMessage(`Enabled ${successCount} mods, ${failCount} failed`, "warning");
        } else {
    ...
    async function handleDisableSelected() {
        ...
        if (failCount > 0) {
            addMessage(`Disabled ${successCount} mods, ${failCount} failed`, "warning");
        } else {
...
{#if hasSelection}
    ...
    <div class="bulk-action-bar" class:light={!$darkMode} transition:fly={{ y: 20, duration: 150 }} onclick={closeDropdown}>
        <span class="count">{selectedCount} mod{selectedCount !== 1 ? "s" : ""} selected</span>
        ...
        <div class="select-dropdown-wrapper">
            ...
            {#if selectDropdownOpen}
                <div class="select-dropdown" class:light={!$darkMode} transition:fly={{ y: -5, duration: 100 }}>
        ...
        <button
            ...
            title={allSelectedEnabled() ? "All selected mods are already enabled" : "Enable selected mods"}
        >
            <Power size={16} />
            Enable
        </button>
        <button
            ...
            title={allSelectedDisabled() ? "All selected mods are already disabled" : "Disable selected mods"}
        >
            <PowerOff size={16} />
            Disable
        </button>
